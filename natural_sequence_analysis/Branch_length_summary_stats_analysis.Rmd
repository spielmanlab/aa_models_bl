...
summarize_branch_lengths(birds) -> birds_bl
...
#As explained above, there will be one type 1, four type 2, and four type 3 linear models run for the mean_bl summary statistic.
bl_lm (summarized_bl, "type_1", summarized_bl$mean_bl)
bl_lm (summarized_bl, "type_2", summarized_bl$mean_bl)
bl_lm (summarized_bl, "type_3", summarized_bl$mean_bl)

bl_lm (birds_bl, "type_2", birds_bl$mean_bl)
bl_lm (birds_bl, "type_3", birds_bl$mean_bl)

bl_lm (mammals_bl, "type_2", mammals_bl$mean_bl)
bl_lm (mammals_bl, "type_3", mammals_bl$mean_bl)

bl_lm (enzymes_bl, "type_2", enzymes_bl$mean_bl)
bl_lm (enzymes_bl, "type_3", enzymes_bl$mean_bl)
...
bl_lm (summarized_bl, "type_1", summarized_bl$treelength)
bl_lm (summarized_bl, "type_2", summarized_bl$treelength)
bl_lm (summarized_bl, "type_3", summarized_bl$treelength)

bl_lm (birds_bl, "type_2", birds_bl$treelength)
bl_lm (birds_bl, "type_3", birds_bl$treelength)

bl_lm (mammals_bl, "type_2", mammals_bl$treelength)
bl_lm (mammals_bl, "type_3", mammals_bl$treelength)

bl_lm (enzymes_bl, "type_2", enzymes_bl$treelength)
bl_lm (enzymes_bl, "type_3", enzymes_bl$treelength)
...
#As explained above, there will be one type 1, four type 2, and four type 3 linear models run for the treelength summary statistic.
bl_lm (summarized_bl, "type_1", summarized_bl$max_bl)
bl_lm (summarized_bl, "type_2", summarized_bl$max_bl)
bl_lm (summarized_bl, "type_3", summarized_bl$max_bl)

bl_lm (birds_bl, "type_2", birds_bl$max_bl)
bl_lm (birds_bl, "type_3", birds_bl$max_bl)

bl_lm (mammals_bl, "type_2", mammals_bl$max_bl)
bl_lm (mammals_bl, "type_3", mammals_bl$max_bl)

bl_lm (enzymes_bl, "type_2", enzymes_bl$max_bl)
bl_lm (enzymes_bl, "type_3", enzymes_bl$max_bl)
