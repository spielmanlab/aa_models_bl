...
## First let's fread in the datasets, create smaller versions of them to work with, and then create a tibble with several branch length summary statistics.
...
``` {r, bl_lm function with gt chart, out.width=8, out.height=6}
...
bl_lm_chart<- function (input_branchlength_df, model_type, dependent_variable_column, plot_title)
{
...
```{r bl_lm function for graph}

#Linear model with three different types, each with different predictors. Once a lm is performed, do an aov and tukey test for significance and report the results as a plot where the models will be compared. Significant values are shown by confidence intervals that do not cross the x=0 line. The four arguments for this function are the branch length dataframe to be used, the type of model to run, which summary statistic to run the model on, and what to title the table/plot.

#Note that this function only creates the graph, and the earlier function creates the cooresponding chart that will be visible for each individual lm.

bl_lm_plot<- function (input_branchlength_df, model_type, dependent_variable_column, plot_title)
{
  input_branchlength_df %>%
    mutate(ASRV_modified= if_else(ASRV==TRUE, "Yes", "No")) -> df_for_modeling
...
Before we run our linear models, let's take a closer look at these functions.
...
bl_lm_chart(summarized_bl, "type_1", summarized_bl$mean_bl,"Type 1 lm Estimates of Mean BL")
bl_lm_plot(summarized_bl, "type_1", summarized_bl$mean_bl,"Type 1 lm Estimates of Mean BL")
bl_lm_chart(summarized_bl, "type_2", summarized_bl$mean_bl,"Type 2 lm Estimates of Mean BL")
bl_lm_plot(summarized_bl, "type_2", summarized_bl$mean_bl,"Type 2 lm Estimates of Mean BL")
bl_lm_chart(summarized_bl, "type_3", summarized_bl$mean_bl,"Type 3 lm Estimates of Mean BL")
bl_lm_plot(summarized_bl, "type_3", summarized_bl$mean_bl,"Type 3 lm Estimates of Mean BL")
```


## Birds_bl mean_bl
```{r, lm for mean bl birds}
bl_lm_chart(birds_bl, "type_2", birds_bl$mean_bl, "Type 2 lm Estimates of Mean BL")
bl_lm_plot(birds_bl, "type_2", birds_bl$mean_bl, "Type 2 lm Estimates of Mean BL")
bl_lm_chart(birds_bl, "type_3", birds_bl$mean_bl, "Type 3 lm Estimates of Mean BL")
bl_lm_plot(birds_bl, "type_3", birds_bl$mean_bl, "Type 3 lm Estimates of Mean BL")
```
...
bl_lm_chart (mammals_bl, "type_2", mammals_bl$mean_bl, "Type 2 lm Estimates of Mean BL")
bl_lm_plot (mammals_bl, "type_2", mammals_bl$mean_bl, "Type 2 lm Estimates of Mean BL")
bl_lm_chart (mammals_bl, "type_3", mammals_bl$mean_bl,"Type 3 lm Estimates of Mean BL")
bl_lm_plot (mammals_bl, "type_3", mammals_bl$mean_bl,"Type 3 lm Estimates of Mean BL")
```

## Enzymes_bl mean_bl
```{r lm for mean bl enzymes}
bl_lm_chart(enzymes_bl, "type_2", enzymes_bl$mean_bl,"Type 2 lm Estimates of Mean BL")
bl_lm_plot(enzymes_bl, "type_2", enzymes_bl$mean_bl,"Type 2 lm Estimates of Mean BL")
bl_lm_chart (enzymes_bl, "type_3", enzymes_bl$mean_bl, "Type 3 lm Estimates of Mean BL")
bl_lm_plot (enzymes_bl, "type_3", enzymes_bl$mean_bl, "Type 3 lm Estimates of Mean BL")
```
...
bl_lm_chart(summarized_bl, "type_1", summarized_bl$treelength,"Type 1 lm Estimates of Treelength")
bl_lm_plot(summarized_bl, "type_1", summarized_bl$treelength,"Type 1 lm Estimates of Treelength")
bl_lm_chart(summarized_bl, "type_2", summarized_bl$treelength, "Type 2 lm Estimates of Treelength")
bl_lm_plot(summarized_bl, "type_2", summarized_bl$treelength, "Type 2 lm Estimates of Treelength")
bl_lm_chart(summarized_bl, "type_3", summarized_bl$treelength, "Type 3 lm Estimates of Treelength")
bl_lm_plot(summarized_bl, "type_3", summarized_bl$treelength, "Type 3 lm Estimates of Treelength")
...
bl_lm_chart(birds_bl, "type_2", birds_bl$treelength,"Type 2 lm Estimates of Treelength")
bl_lm_plot(birds_bl, "type_2", birds_bl$treelength,"Type 2 lm Estimates of Treelength")
bl_lm_chart(birds_bl, "type_3", birds_bl$treelength,"Type 3 lm Estimates of Treelength")
bl_lm_plot(birds_bl, "type_3", birds_bl$treelength,"Type 3 lm Estimates of Treelength")
```

## Mammals_bl Treelength
```{r lm for treelength mammals}

bl_lm_chart(mammals_bl, "type_2", mammals_bl$treelength,"Type 2 lm Estimates of Treelength")
bl_lm_plot(mammals_bl, "type_2", mammals_bl$treelength,"Type 2 lm Estimates of Treelength")
bl_lm_chart(mammals_bl, "type_3", mammals_bl$treelength,"Type 3 lm Estimates of Treelength")
bl_lm_plot(mammals_bl, "type_3", mammals_bl$treelength,"Type 3 lm Estimates of Treelength")
```

## Enzymes_bl Treelength
```{r lm for treelength enzymes}

bl_lm_chart(enzymes_bl, "type_2", enzymes_bl$treelength,"Type 2 lm Estimates of Treelength")
bl_lm_plot(enzymes_bl, "type_2", enzymes_bl$treelength,"Type 2 lm Estimates of Treelength")
bl_lm_chart(enzymes_bl, "type_3", enzymes_bl$treelength, "Type 3 lm Estimates of Treelength")
bl_lm_plot(enzymes_bl, "type_3", enzymes_bl$treelength, "Type 3 lm Estimates of Treelength")
...
bl_lm_chart(summarized_bl, "type_1", summarized_bl$max_bl,"Type 1 lm Estimates of Max BL")
bl_lm_plot(summarized_bl, "type_1", summarized_bl$max_bl,"Type 1 lm Estimates of Max BL")
bl_lm_chart(summarized_bl, "type_2", summarized_bl$max_bl,"Type 2 lm Estimates of Max BL")
bl_lm_plot(summarized_bl, "type_2", summarized_bl$max_bl,"Type 2 lm Estimates of Max BL")
bl_lm_chart(summarized_bl, "type_3", summarized_bl$max_bl,"Type 3 lm Estimates of Max BL")
bl_lm_plot(summarized_bl, "type_3", summarized_bl$max_bl,"Type 3 lm Estimates of Max BL")
```

## Birds_bl max_bl
```{r lm for max bl birds}
bl_lm_chart(birds_bl, "type_2", birds_bl$max_bl,"Type 2 lm Estimates of Max BL")
bl_lm_plot(birds_bl, "type_2", birds_bl$max_bl,"Type 2 lm Estimates of Max BL")
bl_lm_chart(birds_bl, "type_3", birds_bl$max_bl,"Type 3 lm Estimates of Max BL")
bl_lm_plot(birds_bl, "type_3", birds_bl$max_bl,"Type 3 lm Estimates of Max BL")
```


## Mammals_bl max_bl
```{r lm for max bl mammals}
bl_lm_chart(mammals_bl, "type_2", mammals_bl$max_bl,"Type 2 lm Estimates of Max BL")
bl_lm_plot(mammals_bl, "type_2", mammals_bl$max_bl,"Type 2 lm Estimates of Max BL")
bl_lm_chart(mammals_bl, "type_3", mammals_bl$max_bl,"Type 3 lm Estimates of Max BL")
bl_lm_plot(mammals_bl, "type_3", mammals_bl$max_bl,"Type 3 lm Estimates of Max BL")
```

## Enzymes_bl max_bl
``` {r lm for max bl enzymes}
bl_lm_chart(enzymes_bl, "type_2", enzymes_bl$max_bl, "Type 2 lm Estimates of Max BL")
bl_lm_plot(enzymes_bl, "type_2", enzymes_bl$max_bl, "Type 2 lm Estimates of Max BL")
bl_lm_chart(enzymes_bl, "type_3", enzymes_bl$max_bl,"Type 3 lm Estimates of Max BL")
bl_lm_plot(enzymes_bl, "type_3", enzymes_bl$max_bl,"Type 3 lm Estimates of Max BL")
```
