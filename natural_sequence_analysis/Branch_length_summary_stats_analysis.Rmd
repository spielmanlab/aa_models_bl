...
#show violin plots for treelength, max_bl, and mean_bl
...
#patchwork AND cowplot were giving me a ROUGH time, outputs were always cut off
(violin_treelength)
(violin_mean_bl)
(violin_max_bl)
```
...

{
  gt(Chart_output_wide)%>% #the outputs were a little ugly, so put them right into gt chart
    ...
    fmt_number(columns="p adj", decimals=3)%>% #No scientific notation, plz and thx
