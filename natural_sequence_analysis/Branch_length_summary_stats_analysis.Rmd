...
#CAN NOT DO TYPE ONE ON THE MAMMALS, ENZYMES, OR BIRDS ALONE SINCE THERE IS NO VARIATION IN *DATASET*
bl_lm_type1(summarized_bl, summarized_bl$mean_bl)
bl_lm_type2(summarized_bl, summarized_bl$mean_bl)
bl_lm_type3(summarized_bl, summarized_bl$mean_bl)

bl_lm_type2(birds_bl, birds_bl$mean_bl)
bl_lm_type3(birds_bl, birds_bl$mean_bl)

bl_lm_type2(mammals_bl, mammals_bl$mean_bl)
bl_lm_type3(mammals_bl, mammals_bl$mean_bl)

bl_lm_type2(enzymes_bl, enzymes_bl$mean_bl)
bl_lm_type3(enzymes_bl, enzymes_bl$mean_bl)
