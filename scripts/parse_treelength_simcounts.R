### SJS
### This script parses and merges results from:
##### Simulation AA counts      -> ../results/simulation_aa_counts.csv
##### Inferred BL across models -> ../results/inferred_branch_lengths.csv
##### Merged file               -> ../results/merged_branch_lengths_counts.csv
